...
public extension ShapeStyle where Self == Color {
    ...
    static var materialUISecondaryBackground: Color {
    ...
    static var materialUITertiaryBackground: Color {
    ...
    static var materialUIPrimaryTitle: Color {
        MaterialUIKit.configuration.colorScheme.primaryTitle
    }
    
    /// The secondary title color based on the current color scheme setting.
    static var materialUISecondaryTitle: Color {
        MaterialUIKit.configuration.colorScheme.secondaryTitle
    }
    
    /// The color used for indicating errors and alerts.
    static var materialUIOnError: Color {
        MaterialUIKit.configuration.colorScheme.onError
    }
    
    /// The separator color based on the current color scheme setting.
    static var materialUISeparator: Color {
        MaterialUIKit.configuration.colorScheme.separator
    }
    
    /// The color used for indicating inactive or disabled state.
    static var materialUIOnDisabled: Color {
        MaterialUIKit.configuration.colorScheme.onDisabled
    }
    
    /// The color used for outlines and stroke.
    static var materialUIOutline: Color {
        MaterialUIKit.configuration.colorScheme.outline
    }
}
